...
- [Add missing hot-path indexes and drop redundant ones](docs/backlog/feature-2026-06-10-hot-path-indexes.md) - pulled up from Next; medium; one migration that can also carry the JobStatusCounts index and the status-vocabulary CHECK constraints.
...
- Shipped since the prior 2026-06-20 pass: [dispatch-provider-capability-filter](docs/backlog/closed/bug-2026-06-19-dispatch-provider-capability-filter.md) (was Now #1), closed 2026-06-20 - workers now report `supports_workspaces` at registration (proto field 12, persisted via migration 000017 with a `COALESCE`/`DEFAULT TRUE` rolling-upgrade guard) and `selectWorker` hard-skips providerless workers for source-bearing tasks, holding them pending (re-dispatched on a capable-worker connect) instead of routing them to fail.
- Reordered: with dispatch-provider shipped, the Now tier shifts up - `job-cancel-missing-authz` (security) takes Now #1 and `hot-path-indexes` is pulled up from Next into Now; `race-test-target-perforce-package` moves Later -> Next, and `dispatch-failure-paths-silent` is surfaced into Later.
- Earlier this cycle: [spa-401-redirect-loop](docs/backlog/closed/bug-2026-06-10-spa-401-redirect-loop.md), [forced-cancel-send-backpressure](docs/backlog/closed/bug-2026-06-19-forced-cancel-send-backpressure.md) (PR #44), [schedrunner-poisoned-tick](docs/backlog/closed/bug-2026-06-10-schedrunner-poisoned-tick.md) (PR #40), [drain-mode-disable-test-asserts-running](docs/backlog/closed/bug-2026-06-19-drain-mode-disable-test-asserts-running.md) (PR #43), [finishregister-gap-connection-epoch-race](docs/backlog/closed/bug-2026-06-19-finishregister-gap-connection-epoch-race.md) (PR #38), and [job-status-recompute-race](docs/backlog/closed/bug-2026-06-10-job-status-recompute-race.md) (PR #36). [default-cancel-abandon-backpressure-bound-test](docs/backlog/idea-2026-06-20-default-cancel-abandon-backpressure-bound-test.md) and [vet-integration-tagged-build](docs/backlog/idea-2026-06-20-vet-integration-tagged-build.md) remain open.
