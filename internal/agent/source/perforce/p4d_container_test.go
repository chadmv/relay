...
// not chosen to pay for two tests. Because both skip conditions above call
// t.Skip rather than t.Fatal, adding this package to an existing lane without
// also supplying both of those things produces a job that reports green
// having run nothing.
